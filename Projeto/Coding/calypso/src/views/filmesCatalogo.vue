  ...
  <div>
    ...
    <body>
      <div>
        <b-row>
          <b-col>
            <nav class="navbar navbarcatalogos">
              <div>
                <b-dropdown text="Ano" class="m-md-2 btn-outline">
                ...
                <b-dropdown text="Categoria" class="m-md-2 btn-outline">
...
export default {
  ...
  methods: {
    ...
    chooseFilm(title) {
      this.SET_ACTUAL_FILM(title);
      this.$router.push("filmsDetalhes");
    },
  },
};
</script>
